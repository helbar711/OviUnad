...
var words=["SFRNTA","RUxFTUVOVE9TIFNFTcFOVElDT1M","Q09OVFJPTCBERSBGT1JNVUxBUklPUw","Rk9STUFUTw","RElTRdFPIERFIFNJVElPUyBXRUI","","","","",""];imaW=["","","","","","","","","",""];queW=["","","","","","","","","",""];
var auW=["","","","","","","","","",""];
var fillLetter="ABCDEFGHIJKLMNÑOPQRSTUVWXYZÁÉÍÓÚÜ "; wordsG=[]; indexG=0; actMaxWidth=550; indexWord=0; totalWord=0;
var imageW=[];questionW=[];audioW=[];profG=0; dirMedia="actividad3_resources/media/"; textBNext="";
