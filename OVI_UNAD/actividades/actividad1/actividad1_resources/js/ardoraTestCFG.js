...
var tags=["¿Cual es la etiqueta que se usa para marcar la cabecera de una página?","¿Cuál es la etiqueta correcta para indicar el pie de página de un sección?","\"El elemento representa una parte de una página que enlaza<br>a otras páginas o partes dentro de la página. Es una sección con enlaces<br>de navegación.\" El anterior enunciado corresponde a cual etiqueta"];
var answers1=["MWhlYWRlcg","MGJvZHk","MGRpdg","MGltZw"];
var answers2=["MWZvb3Rlcg","MHNlY3Rpb24","MGFzaWRl","MGFydGljbGU"];
var answers3=["MW5hdg","MGRpdg","MHNlY3Rpb24","MGltZw"];
